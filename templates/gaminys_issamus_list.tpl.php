...
<div id="actions">
	<a href='index.php?module=<?php echo $module; ?>&action=create'>Naujas receptas</a>
</div>
<div class="float-clear"></div>

<?php if(isset($_GET['remove_error'])) { ?>
	<div class="errorBox">
		Gaminys nebuvo pašalintas. Pirmiausia pašalinkite uzsakomi_patiekalai ryšius.
	</div>
<?php } ?>
			...
			echo
				"<tr>"
					...
					. "<td>"	. "<a href='#' onclick='showConfirmDialog(\"{$module}\", \"{$val['id_GAMINYS']}\"); return false;' title=''>šalinti</a>&nbsp;"
						. "<a href='index.php?module={$module}&action=edit&id={$val['id_GAMINYS']}' title=''>redaguoti</a>"
					. "</td>"
				. "</tr>";
		}
	?>
